...
// It matches the signature of gateway.URLSource.TargetURL
...
func NewHTTPRelayer(client *http.Client, gatewaySource GatewaySource) *HTTPRelayer {
	return &HTTPRelayer{
		client:        client,
		gatewaySource: gatewaySource,
	}
...
func (r *HTTPRelayer) Relay(ctx context.Context, host string, body []byte, contentType string, method string) (*http.Response, error) {
	...
	gwURL, err := r.gatewaySource.TargetURL(ctx, host)
	if err != nil {
