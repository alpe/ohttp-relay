...
var (
	...
	TrafficBytesIn       metric.Int64Counter
	TrafficBytesOut      metric.Int64Counter
...
func InitMetrics() error {
	...
	TrafficBytesIn, initErr = meter.Int64Counter(
		"ohttp_relay_traffic_bytes_in_total",
	...
	TrafficBytesOut, initErr = meter.Int64Counter(
		"ohttp_relay_traffic_bytes_out_total",
...
// RecordTrafficIO records traffic IO metrics (bytes in and out) for a given host
func RecordTrafficIO(ctx context.Context, host string, bytesIn, bytesOut int64) {
	attrs := metric.WithAttributes(
		attribute.String("host", host),
	)

	TrafficBytesIn.Add(ctx, bytesIn, attrs)
	TrafficBytesOut.Add(ctx, bytesOut, attrs)
}
